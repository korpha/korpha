...
def _build_attempt_prompt(task: str) -> str:
    return (
        ...
        "not running in a tool-call loop — your job is to produce the "
        "deliverable directly using your training. If you'd benefit "
        "from web research, draft the deliverable using your best "
        "knowledge and add 'next step: refine with current data' to "
        "the detail field. Skill invocation happens at a higher layer.\n"
